...
public class UserRoomListAdapter extends RecyclerView.Adapter<UserRoomListAdapter.Holder> {
    ...
    public UserRoomListAdapter(Context context){
        mContxt=context;
        funLiveRoomList=new ArrayList<>();
    }
    public UserRoomListAdapter(Context context,List<FunLiveRoom> list) {
        mContxt=context;
        funLiveRoomList=list;
    }
